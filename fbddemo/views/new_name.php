...
?>
<h1><?php echo __('New Name'); ?></h1>
<form action="<?php echo BASE_URL; ?>plugin/fbddemo/new_name_2db" method="post">
    <fieldset style="padding:0.5em;">
        <legend style="padding: 0em 0.5em 0em 0.5em; font-weight: bold;"><?php echo __('New Name'); ?></legend>
		<table class="fieldset" cellspacing="0" cellpadding="0" border="0">
			<tr>
				<td>
					<label for="fbddemo-name"><?php echo __('Name'); ?>&nbsp;</label>
					<input type="text" id="fbddemo-name" name="fbddemo[name]" class="textbox" value="" />
				</td>
			</tr>
        </table>
    </fieldset>
